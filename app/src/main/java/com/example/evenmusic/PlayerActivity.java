...
import com.example.evenmusic.util.MediaUtils;
import com.example.evenmusic.view.VisualizerView;
...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void updateAlbum(String path) {
        ...
        if (bitmap != null) {
            ...
            mAlbumImageView.setImageResource(R.drawable.default_album);
        }
    }
    ...
    private void changeListOrder() {
        ...
        if (mIsShuffle) {
            mShuffleButton.setBackgroundResource(R.drawable.btn_playback_shuffle_all);
        } else {
            mShuffleButton.setBackgroundResource(R.drawable.shuffle);
        }
    }
    ...
    public void changeLoopWay() {
        ...
        if (mLoopWay == AudioPlayService.LIST_NOT_LOOP) {
            ...
            mRepeatButton.setBackgroundResource(R.drawable.btn_playback_repeat_all);
        } else if (mLoopWay == AudioPlayService.LIST_LOOP) {
            mLoopWay = AudioPlayService.AUDIO_REPEAT;
            mRepeatButton.setBackgroundResource(R.drawable.btn_playback_repeat_one);
        } else {
            mLoopWay = AudioPlayService.LIST_NOT_LOOP;
            mRepeatButton.setBackgroundResource(R.drawable.repeat);
        }
...
//            mPauseButtonBackground.setBackgroundResource(R.drawable.shadowed_circle_red);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLyricView = (LyricView) findViewById(R.id.lyric_view1);
        mLyricButton = (ImageButton)findViewById(R.id.lyricButton);
...
//        mPauseButtonBackground.setOnClickListener(this);
        ...
        mLyricButton.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.returnButton:
                ...
                break;
            case R.id.lyricButton:
                Intent newIntent = new Intent(PlayerActivity.this, LyricActivity.class);
                newIntent.putExtra(AudioPlayService.AUDIO_PATH_STR, mPath);
                newIntent.putExtra(AudioPlayService.AUDIO_TITLE_STR, mTitleTextView.getText().toString());
                newIntent.putExtra(AudioPlayService.AUDIO_ARTIST_STR, mArtistTextView.getText().toString());
                newIntent.putExtra(AudioPlayService.AUDIO_CURRENT_INT, 0);
