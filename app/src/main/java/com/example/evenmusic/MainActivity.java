...
import com.example.evenmusic.adapter.AudioListAdapter;
import com.example.evenmusic.adapter.ViewPagerAdapter;
...
import com.example.evenmusic.util.AudioList;
import com.example.evenmusic.util.AudioToAudioItem;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private PagerTabStrip mPaperTabStrip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPaperTabStrip = (PagerTabStrip) findViewById(R.id.tab_strip);

        //设置tab栏字体
        mPaperTabStrip.setTextColor(Color.rgb(0, 0, 0));
        mPaperTabStrip.setTabIndicatorColor(Color.rgb(160, 187, 199));
        mPaperTabStrip.setTextSpacing(50);
    ...
    private void playAudio(int position, boolean start, boolean shuffle, boolean forced) {
        if (forced || position != mLastPlay) {
            ...
            if (bitmap != null) {
                ...
                mBarAlbum.setImageResource(R.drawable.default_album);
            }
            enableButton(false);
